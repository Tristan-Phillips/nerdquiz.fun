class Quiz {
    ...
    getRandomQuestion() {
        ...
        if (available.length === 0) {
            // Reset used indices if all questions have been used
            this.usedIndices.clear();
    ...
    updateDisplay() {
        ...
        document.getElementById('answer-text').textContent = ''; // Clear previous answer
    }
    ...
    playQuestionAudio() {
        this.stopAudio();
        this.currentAudio = new Audio(`./${this.currentQuestion.questionAudioPath}`);
        this.currentAudio.play().catch(() => {});
    }

    playAnswerAudio() {
        this.stopAudio();
        this.currentAudio = new Audio(`./${this.currentQuestion.answerAudioPath}`);
        this.currentAudio.play().catch(() => {});
    }
